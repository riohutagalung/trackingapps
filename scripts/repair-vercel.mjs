...
// Known safe source repairs only. No business/GPS calculations are changed.
html=html.replace(/\},\,/g,'},');
...
// Cache-bust the RPC bridge so browsers/WebViews stop using an older bridge copy.
html=html.replace(/gas-bridge\.js(?:\?v=\d+)?/g,'gas-bridge.js?v=20260921');

// App.init() calls Weather.refresh(); ensure a real client Weather module exists.
...
// Validate all inline JavaScript before Vercel/native packaging.
